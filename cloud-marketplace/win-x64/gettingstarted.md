...
To launch the Titan MFT Administrator click on the Titan MFT Server desktop icon which will launch the browser and connect to the default localhost admin port of 37443. The first time you run the Administrator it will prompt you to create a new Administrator account to allow configuring the server.
